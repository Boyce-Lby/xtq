    ...
    <header class="head-section">
        <div class="navbar navbar-default navbar-static-top container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html"><span>哮天犬</span>忠诚·美好·生活</a>
            ...
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        <a class="dropdown-toggle" data-close-others="false" data-delay="0" data-hover="dropdown" data-toggle="dropdown" href="#">社区中心 <i class="fa fa-angle-down"></i>
                      </a>
                        <ul class="dropdown-menu">
                            <li>
                                <a href="sqsh.html">社区生活</a>
                            </li>
                            <li>
                                <a href="ygzw.html">阳光政务</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li class="dropdown">
                        <a class="dropdown-toggle" data-close-others="false" data-delay="0" data-hover="dropdown" data-toggle="dropdown" href="#">店铺 <i class="fa fa-angle-down"></i>
                      </a>
                        <ul class="dropdown-menu">
                            <li>
                                <a href="dplb.html">店铺列表</a>
                            </li>
                            <li>
                    ...
                    <li><input class="form-control search" placeholder="搜索" type="text"></li>
                </ul>
            </div>
        </div>
    </header>
            ...
            <div class="container" style="padding-bottom:100px;">
                <div class="profile-header row">
                    <div class="col-lg-2 col-md-4 col-sm-12 text-center">
                        <img src="img/head.jpg" data-toggle="modal" data-target="#avatar-modal" class="header-avatar">
                    </div>
                    <div class="col-lg-5 col-md-8 col-sm-12 profile-info">
                        <div class="header-fullname">小龙套</div>
                        <button class="btn btn-success btn-sm  btn-follow" data-toggle="modal" data-target="#editUserModal" data-uid="小龙套">
                        ...
                        <div class="header-information">
                            <span>手机：未绑定</span> | <span>邮箱：未绑定</span> | <span>用户组：普通会员</span>
                        </div>
                    </div>
                                                ...
                                                <table class="table table-responsive table-striped table-advance table-hover order-table">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="#">
                                                                    <img src="img/product2.jpg" alt="商品名字" width="40" height="40"> 商品名字商品名字
                                                                </a>
                                                            </td>
                                                            <td>￥111 </td>
